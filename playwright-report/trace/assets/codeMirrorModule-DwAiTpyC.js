...
`
          ...
          var Nn = {
            selectAll: El,
            singleSelection: (e) =>
              e.setSelection(e.getCursor("anchor"), e.getCursor("head"), Ve),
            killLine: (e) =>
              en(e, (t) => {
                if (t.empty()) {
            ...
            delLineLeft: (e) =>
              en(e, (t) => ({ from: L(t.from().line, 0), to: t.from() })),
            ...
            goDocStart: (e) => e.extendSelection(L(e.firstLine(), 0)),
            goDocEnd: (e) => e.extendSelection(L(e.lastLine())),
            goLineStart: (e) =>
              e.extendSelectionsBy((t) => Yl(e, t.head.line), {
                origin: "+move",
                bias: 1,
              }),
            goLineStartSmart: (e) =>
              e.extendSelectionsBy((t) => Zl(e, t.head), {
                origin: "+move",
                bias: 1,
              }),
            goLineEnd: (e) =>
              e.extendSelectionsBy((t) => hu(e, t.head.line), {
                origin: "+move",
                bias: -1,
              }),
            goLineRight: (e) =>
      ...
      ((Et, zt) => {
        ((C) => {
          ...
          C.defineMIME("text/css", {
            ...
            tokenHooks: {
              "/": (fe, H) =>
                fe.eat("*") ? ((H.tokenize = ze), ze(fe, H)) : !1,
            },
            name: "css",
          }),
            C.defineMIME("text/x-scss", {
              ...
              tokenHooks: {
                ...
                "#": (fe) => (fe.eat("{") ? [null, "interpolation"] : !1),
              },
              name: "css",
              helperType: "scss",
            }),
                ...
                if (y && y[1])
                  for (; m; )
                    if (m.tagName == y[2]) {
                      m = m.prev;
                      break;
                    } else if (Object.hasOwn(b.implicitlyClosed, te(m.tagName)))
                      m = m.prev;
                    else break;
                else if (y)
                  for (; m; ) {
          ...
          C.defineMode(
            ...
            (ie, O) => {
              ...
              return {
                ...
                token: (re, ne) => ne.token(re, ne),
                indent: (re, ne, se) =>
                  !re.localMode || /^\s*<\//.test(ne)
        ...
        ((C) => {
              ...
              hooks: {
                "@": (m) =>
                  m.match("interface", !1)
                    ...
                    : (m.eatWhile(/[\w$_]/), "meta"),
                '"': (m, y) =>
                  m.match(/""$/) ? ((y.tokenize = D), y.tokenize(m, y)) : !1,
              },
          ...
          Ee("text/x-scala", {
            ...
            hooks: {
              ...
              "/": (m, y) =>
                m.eat("*") ? ((y.tokenize = J(1)), y.tokenize(m, y)) : !1,
            },
          ...
          Ee("text/x-kotlin", {
            ...
            hooks: {
              "@": (m) => (m.eatWhile(/[\w$_]/), "meta"),
              "*": (m, y) => (y.prevToken == "." ? "variable" : "operator"),
              '"': (m, y) => (
                (y.tokenize = d(m.match('""'))), y.tokenize(m, y)
              ),
              "/": (m, y) =>
                m.eat("*") ? ((y.tokenize = J(1)), y.tokenize(m, y)) : !1,
              indent: (m, y, P, le) => {
